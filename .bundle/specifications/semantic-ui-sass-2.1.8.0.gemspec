# -*- encoding: utf-8 -*-
# stub: semantic-ui-sass 2.1.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.date = "2016-01-14"
  s.description = "Semantic UI, converted to Sass and ready to drop into Rails & Compass.".freeze
  s.email = ["doinsist@gmail.com".freeze]
  s.homepage = "http://github.com/doabit/semantic-ui-sass".freeze
  s.licenses = ["MIT".freeze]
  s.rubygems_version = "2.6.3".freeze
  s.summary = "Semantic UI, converted to Sass and ready to drop into Rails & Compass.".freeze
